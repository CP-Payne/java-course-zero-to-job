...
// The majority of the below code is the solution from the video
...
//		double[][] rotatedArray = new double[matrixSize][matrixSize];
//		
//		for (int r=0; r<matrix.length; r++) {
//			int counter = 0;
//			for (int c=0; c < matrix[r].length; c++) {
//				//rotatedArray[counter][(matrixSize-1)-r] = matrix[r][c];
//				rotatedArray[counter][(matrixSize-1)-r] = matrix[r][c];
//				counter++;
//			}
//		}
